...
import { navigationConstants, userDataConstants } from "../../redux/constants";
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onChangeLayout: (layout) =>
      dispatch({ type: navigationConstants.CHANGE_LAYOUT, layout: layout }),
    initUserData: () => dispatch(userDataActions.initApp()),
  };
};
